                    ...
                    <div className='row'>
                        <div className='mb-12 col-sm-12 col-md-6'>
                            <div className="mb-3">
                                ...
                                <span style={{ color: 'red' }}>{validator.current.message('company name', sendReq.cname, 'required')}</span>
                            </div>
                        </div>
                        <div className='mb-12 col-sm-12 col-md-6'>
                            <div className="mb-3">
                                ...
                                <span style={{ color: 'red' }}>{validator.current.message('party name', sendReq.pname, 'required')}</span>
                            </div>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='mb-12 col-sm-12 col-md-6'>
                            <div className="mb-3">
                                ...
                                <span style={{ color: 'red' }}>{validator.current.message('broker name', sendReq.bname, 'required')}</span>
                            </div>
                        </div>
                        <div className='mb-12 col-sm-12 col-md-6'>
                            <div className="mb-3">
